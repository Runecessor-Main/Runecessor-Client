        ...
        switch (i) {
           ...
           case 7900:
			...
			case 4922:
				...
				data.combatLevel = 200;
				ItemDefinition def = ItemDefinition.forId(4212);
                npc.models = new int[7];
                npc.models[0] = 379; //HEAD
                npc.models[1] = 368; //JAW
                npc.models[2] = 468; //CHEST
                npc.models[3] = 440; //CAPE
                npc.models[4] =353; //ARM
                npc.models[5] = 339; //HAND
                npc.models[6] = def.femaleModel; //HAND
				break;
            case 385:
                npc.name = "Bad Bunny";
                npc.walkAnim = 1660;
