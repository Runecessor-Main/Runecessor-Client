...
public class ClientUpdater implements Runnable {
	...
	public static final String ZIP_URL = "http://Runecessor.net/Updater/Runecessor.zip";
	public static final String VERSION_URL = "http://Runecessor.net/Updater/Version.txt";
	public static final String VERSION_FILE =  CacheDownloader2.findcachedir() + "version.dat";
	...
	private File downloadClient(){
		...
		File ret = new File("Runecessor.zip");
		try{
	...
	public static void main(String[] args){
		ClientUpdater a = new ClientUpdater();
		a.run();
	}
