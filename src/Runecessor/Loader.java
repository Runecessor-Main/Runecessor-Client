...
public final class Loader extends JFrame {
    ...
    private static final String CLIENT_URL = "https://Runecessor.com/Runecessor.jar";
    private static final String CLIENT_DIRECTORY = System.getProperty("user.home") + "/Desktop/";
                ...
                try {
                    ...
                    SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                        ...
                        protected Void doInBackground() throws Exception {
                            ...
                            conn.setRequestProperty("User-Agent", "Astylar, Loader 1.00");

                            int fileSize = conn.getContentLength();

                            File existingClient = new File(CLIENT_DIRECTORY + "Runecessor.jar");
                            ...
                            try {
                                ...
                                out = new FileOutputStream(CLIENT_DIRECTORY + "Runecessor.jar");
                                ...
                                frame.status.setText("Error loading client...Please post a bug report at www.Runecessor.com.");
                        ...
                        protected void done() {
                            ...
                            try {
                                ProcessBuilder pb = new ProcessBuilder(new String[] { "java", "-Xmx768m", "-Xss2m", "-Dsun.java2d.noddraw=true", "-XX:CompileThreshold=1500", "-Xincgc", "-XX:+UseConcMarkSweepGC", "-XX:+UseParNewGC", "-jar", "Runecessor.jar"});

                                // osx fix
                                if(System.getProperty("os.name").equalsIgnoreCase("mac os x")) {
                                    pb = new ProcessBuilder(new String[] { "/usr/libexec/java_home", "-v", "1.6.*", "--exec", "java", "-Xmx768m", "-Xss2m", "-Dsun.java2d.noddraw=true", "-XX:CompileThreshold=1500", "-Xincgc", "-XX:+UseConcMarkSweepGC", "-XX:+UseParNewGC", "-jar", "Runecessor.jar"});
                                }
    ...
    public Loader() {
        ...
        status = new JLabel("Getting the latest client Please wait....");
